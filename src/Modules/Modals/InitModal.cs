...
public class InitModal : IModal
{
    ...
    [ModalChannelSelect("default-channel", minValues: 0, maxValues: 1)]
    [RequiredInput(false)]
    public ITextChannel[]? DefaultChannel { get; set; }

    [InputLabel("Log Channel", "The channel where the logs are being written to!")]
    [ModalChannelSelect("log-channel", minValues: 0, maxValues: 1)]
    [RequiredInput(false)]
    ...
    [ModalChannelSelect("auto_entry-channel", minValues: 0,  maxValues: 1)]
    [RequiredInput(false)]
    ...
    [ModalChannelSelect("group_entry-channel", minValues: 0, maxValues: 1)]
    [RequiredInput(false)]
